...
public class CartServiceImpl implements CartService {
    ...
    public CartResponse updateSale(CartRequest cartRequest, Integer cartId) {
        log.info("Updating Cart with ID: {} in the database. New Amount: {}, Customer: {}. Product count: {}", cartId, cartRequest.getAmount(), cartRequest.getBuyer().getUsername(), cartRequest.getCartProducts().size());
    ...
    private CartResponse toResponse(Cart cart) {
        ...
        cartResponse.setCartProducts(Collections.unmodifiableSet(toResponse(cart.getCartProducts())));
